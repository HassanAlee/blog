...
export const registerUser = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    ...
    let res = await fetch(
      "https://blog-beta-backend.vercel.app/api/v1/user/register",
      requestOptions
    );
    if (!res.ok) {
      res = await res.json();
...
export const loginUSer = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    ...
    let res = await fetch(
      "https://blog-beta-backend.vercel.app/api/v1/user/login",
      requestOptions
    );
    if (!res.ok) {
      res = await res.json();
...
export const validateUser = createAsyncThunk(
  ...
  async () => {
    ...
    let res = await fetch(
      "https://blog-beta-backend.vercel.app/api/v1/user/verifyToken",
      requestOptions
    );
    if (res.status == 401) {
...
export const updateUser = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    ...
    let res = await fetch(
      "https://blog-beta-backend.vercel.app/api/v1/user/update-profile",
      requestOptions
    );
    if (!res.ok) {
      res = await res.json();
...
export const getAllAuthors = createAsyncThunk(
  ...
  async (thunkAPI) => {
    let res = await fetch(
      "https://blog-beta-backend.vercel.app/api/v1/user/all-authors"
    );
    if (!res.ok) {
      res = await res.json();
...
export const deleteUser = createAsyncThunk(
  ...
  async (id) => {
    ...
    let res = await fetch(
      `https://blog-beta-backend.vercel.app/api/v1/user/delete-account/${id}`,
      requestOptions
    );
    if (!res.ok) {
